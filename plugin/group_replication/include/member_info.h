...
class Group_member_info : public Plugin_gcs_message {
  ...
  */
  ...
  /**
    ...
    advertised
   */
  Group_member_info(const char *hostname_arg, bool primary_election_self_adaption_arg, 
                    const char *group_name_arg, uint port_arg,
  ...
  /**
    ...
    advertised
   */
  void update(const char *hostname_arg, bool primary_election_self_adaption_arg, 
  ...
  */
  bool get_primary_election_self_adaption();
  ...
  */
  ...
  bool has_greater_weight(Group_member_info *other);
   ...
   /**
    Return true if executed gtid is higher than other member weight
   */
